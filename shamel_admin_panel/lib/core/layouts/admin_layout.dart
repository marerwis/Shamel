          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildNavItem(context, 'إدارة التصنيفات', Icons.category, '/categories', location == '/categories'),
                _buildNavItem(context, 'إدارة الخدمات', Icons.home_repair_service, '/services', location == '/services'),
                _buildNavItem(context, 'إدارة الأعضاء (العملاء)', Icons.people, '/members', location == '/members'),
                _buildNavItem(context, 'مزودي الخدمة', Icons.handyman, '/providers', location == '/providers'),
                _buildNavItem(context, 'طلبات العملاء', Icons.podcasts, '/requests', location == '/requests'),
                _buildNavItem(context, 'عروض الأسعار والحظر', Icons.gavel, '/bids_blocks', location == '/bids_blocks'),
                _buildNavItem(context, 'الطلبات المنفذة', Icons.receipt_long, '/orders', location == '/orders'),
                ...
                _buildNavItem(context, 'إعدادات النظام', Icons.settings, '/settings', location == '/settings'),
              ],
            ),
          ),
